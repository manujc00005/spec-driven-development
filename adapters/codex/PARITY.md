...
| Skill contracts (`## SDD Contract`) | on all 65 skills | reused as provider-neutral metadata | ✅ shared |
...
| **Full skill catalogue** | 65 skills | 7-prompt lifecycle spine only | ❌ curated subset (DECISIONS D004) |
