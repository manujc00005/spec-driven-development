...
| Lifecycle steps (create→plan→analyze→implement→review→close) | ✅ `skills/*/SKILL.md` slash commands | ⚠️ prompts in `codex/prompts/` (lifecycle spine only) | Codex prompts derived from the same skill procedures; curated spine, not all 71 skills. |
