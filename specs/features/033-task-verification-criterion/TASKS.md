...
- [ ] T001 - Fix the clause syntax in `specs/_templates/TASKS.md`: a task line gains
...
- [ ] T003 - `skills/spec-analyze/SKILL.md`: return a blocking finding when a task list produced
  after this change has a missing or empty `Verify:`. A file with no `Verify:` anywhere is legacy and
  passes untouched. Covers: AC-002, AC-007.
